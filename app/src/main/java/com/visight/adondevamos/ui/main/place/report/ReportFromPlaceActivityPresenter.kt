...
class ReportFromPlaceActivityPresenter: ReportFromPlaceActivityContract.Presenter {
    ...
    var mSurveySelectedOption: Int? = null
    ...
    override fun setSurveySelectedOption(selectedOption: Int) {
        mSurveySelectedOption = selectedOption
    }

    override fun getSurveySelectedOption(): Int? {
    ...
    override fun sendReport(placeId: String, shouldSendSurveySelectedOption: Boolean) {
        ...
        if(base64Image != null){
            if(!shouldSendSurveySelectedOption){
                request = SendPlacePhotoRequest(placeId, base64Image, null)
            }else{
                request = SendPlacePhotoRequest(placeId, base64Image, mSurveySelectedOption)
            }
            ...
            mView!!.onResponseReport("Por el momento, es necesario que tomes una captura primero")
        }
    }
